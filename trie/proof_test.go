...
// test all variations.
func makeProvers(trie *Trie) []func(key []byte) *abeydb.MemDatabase {
	var provers []func(key []byte) *abeydb.MemDatabase

	// Create a direct trie based Merkle prover
	provers = append(provers, func(key []byte) *abeydb.MemDatabase {
		proof := abeydb.NewMemDatabase()
