...
const (
	...
	subscribeTimeout     = 5 * time.Second  // overall timeout abey_subscribe, rpc_modules calls
)
...
// EthSubscribe registers a subscripion under the "abey" namespace.
func (c *Client) EthSubscribe(ctx context.Context, channel interface{}, args ...interface{}) (*ClientSubscription, error) {
	return c.Subscribe(ctx, "abey", channel, args...)
}
