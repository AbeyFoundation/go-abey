...
// Processor.
func NewSnailBlockChain(db abeydb.Database, chainConfig *params.ChainConfig, engine consensus.Engine, blockchain *core.BlockChain) (*SnailBlockChain, error) {
...
func (bc *SnailBlockChain) GetDatabase() abeydb.Database {
	return bc.db
}
