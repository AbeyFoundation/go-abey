...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gabey.ipc", false, filepath.Join(os.TempDir(), "gabey.ipc")},
		{"data", "gabey.ipc", false, "data/gabey.ipc"},
		{"data", "./gabey.ipc", false, "./gabey.ipc"},
		{"data", "/gabey.ipc", false, "/gabey.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gabey.ipc", true, `\\.\pipe\gabey.ipc`},
		{"data", "gabey.ipc", true, `\\.\pipe\gabey.ipc`},
		{"data", `\\.\pipe\gabey.ipc`, true, `\\.\pipe\gabey.ipc`},
	}
