...
func newPeerConnection(id string, version int, peer abey.Peer, logger log.Logger) *peerConnection {
...
func (p *peerConnection) FetchBodies(request *abey.FetchRequest) error {
	// Sanity check the protocol version
	if p.version < 62 {
...
func (p *peerConnection) FetchReceipts(request *abey.FetchRequest) error {
	// Sanity check the protocol version
	if p.version < 63 {
